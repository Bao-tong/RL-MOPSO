function IPosition=LeaderFindPosition(pop,f1,f2,f3)
           ...
           if (A==1&&C==1)||(A==1&&E==1)|| (C==1&&F==1)        
            ...
            if (A==1 && F==1&&C==0&&D==0)||(A==1&&C==0&&D==0&&E==0&&F==0)||(F==1&&A==0&&B==0&&C==0&&D==0)
              IPosition=pop(randsample([f2,f3], 1)).Position;
            end
            if (C==1 && E==1&&A==0&&B==0)||(C==1&&A==0&&B==0&&E==0&&F==0)||(E==1&&A==0&&B==0&&C==0&&D==0)
              IPosition=pop(randsample([f2,f1], 1)).Position;
            end
            if (B==1 && D==1&&E==0&&F==0)||(B==1&&C==0&&D==0&&E==0&&F==0)||(D==1&&A==0&&B==0&&E==0&&F==0)
              IPosition=pop(randsample([f3, f1], 1)).Position;
            end            
             if A==0 && B==0&&C==0&&D==0&&E==0&&F==0
              IPosition=pop(randsample([f2 , f3, f1], 1)).Position;
            end           
