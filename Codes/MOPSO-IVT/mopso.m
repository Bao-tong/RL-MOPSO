...
for b = 1:num_benchmarks
    ...
    for test = 1:TEST
        ...
        nPop = 200; rows = 25; cols = 8; nRep = 200; w = 0.64; wdamp = 0.99;
        c1 = 2.46; c2 = 0.51; nGrid = 7; alpha = 0.1; gamma = 2;
        u_idx = 1; EPnum = 4; 
        ...
        empty_particle.Normalization = []; empty_particle.Explore = []; empty_particle.repdis = []; 
        ...
        writetable(array2table(ResultsData, 'VariableNames', colNames_res, 'RowNames', rowNames_all), ...
                   'MOPSO-IVT_Results.csv', 'WriteRowNames', true);
                   
        writetable(array2table(IterData, 'VariableNames', colNames_iter, 'RowNames', rowNames_all), ...
                   'MOPSO-IVT_Iterations.csv', 'WriteRowNames', true);
