...
for b = 1:num_benchmarks
    ...
    for test = 1:TEST
        ...
        nPop = 200; nRep = 200; w = 0.74; wdamp = 0.99;
        c1 = 1.57; c2 = 0.35; nGrid = 7; alpha = 0.1; 
        ...
        empty_particle.GridIndex = []; empty_particle.GridSubIndex = []; 
        ...
        writetable(array2table(ResultsData, 'VariableNames', colNames_res, 'RowNames', rowNames_all), ...
                   'MOPSO-Gbest_Results.csv', 'WriteRowNames', true);
                   
        writetable(array2table(IterData, 'VariableNames', colNames_iter, 'RowNames', rowNames_all), ...
                   'MOPSO-Gbest_Iterations.csv', 'WriteRowNames', true);
