...
for b = 1:num_benchmarks
    ...
    for test = 1:TEST
        ...
        nPop = 200; rows = 20; cols = 10; nRep = 200; w = 0.5; wdamp = 0.99;
        c1 = 1.5; c2 = 1.5; nGrid = 7; alpha = 0.1; gamma = 2;
        u_idx = 1; 
        ...
        writetable(array2table(ResultsData, 'VariableNames', colNames_res, 'RowNames', rowNames_all), ...
                   'MOPSO-Von-Neumann_Results.csv', 'WriteRowNames', true);
                   
        writetable(array2table(IterData, 'VariableNames', colNames_iter, 'RowNames', rowNames_all), ...
                   'MOPSO-Von-Neumann_Iterations.csv', 'WriteRowNames', true);
